...
namespace Drupal\price_template_formatter\Plugin\Field\FieldFormatter;
...
/**
 * Plugin implementation of the 'price_template_formatter' formatter.
 *
 * @FieldFormatter(
 *   id = "price_template_formatter",
  ...
  public function viewElements(FieldItemListInterface $items, $langcode) {
    ...
    if (!$items->isEmpty()) {
      ...
      if ($price_display_without_promotion != $price_display) {
        ...
        $discount = "";
        $price_display_without_promotion = "";
      }

      $elements[0] = [
        '#theme' => 'price_formatter',
        '#price_old' => (string)$price_display_without_promotion,
        '#discount' => (string)$discount,
        '#price' => (string)$price_display,
        '#cache' => [
